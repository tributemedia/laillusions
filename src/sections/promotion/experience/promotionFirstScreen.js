...
const PromotionSlider = dynamic(() => import('../experience/promotionSlider'), { ssr: false });
        ...
        <div className="promotionFirstScreen__top flex">
          <div className="promotionFirstScreen__top_img">
            <Image
              ...
              src="/assets/promotion/experience/51.webp"
              alt="img"
              width={540}
              height={540}
              priority
          ...
          <div className="promotionFirstScreen__top_text">
            <div className="promotionFirstScreen__top_text-title">VIP Experience</div>
            <div className="promotionFirstScreen__top_text-text">
              Step into the spotlight and live like a VIP at the World of Illusions! You&apos;ll be guided on a tour of the museum by your photographer, who will capture every moment of your experience. Say cheese as you feel like a movie star, with a paparazzi-style photo shoot that will give you picture-perfect memories to treasure. At the end of the experience, all VIP guests receive a special gift, making this the ultimate way to enjoy a fun date or create picture-perfect memories for your social media. Get ready to dazzle, as the World of Illusions offers a unique VIP experience that you won&apos;t forget!            </div>
