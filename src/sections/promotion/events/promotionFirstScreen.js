...
const PromotionSlider = dynamic(() => import('../events/promotionSlider'), { ssr: false });
        ...
        <div className="promotionFirstScreen__top flex">
          <div className="promotionFirstScreen__top_img">
            <Image
              ...
              src="/assets/promotion/events/51.webp"
              alt="img"
              width={540}
              height={540}
              priority
          ...
          <div className="promotionFirstScreen__top_text">
            <div className="promotionFirstScreen__top_text-title">Birthdays, Parties, and Events</div>
            <div className="promotionFirstScreen__top_text-text">
              Step right up and prepare to be wowed at the World of Illusions! Celebrate birthdays, parties, and events in a truly unforgettable way. Our interactive exhibits and art pieces will transport you to a world of wonder and amazement. Snap photos of your guests as they experience the thrill of riding aboard the Titanic or surviving a meteor shower. We offer special pricing for groups of all sizes, so we&apos;ve got you covered no matter the occasion. Let us help plan your next visit and create memories that will last a lifetime. Get in touch with us today, and let the illusions begin!            </div>
