...
const PromotionFirstScreen = dynamic(() => import('../sections/promotion/events/promotionFirstScreen'));
...
const BlockFAQ = dynamic(() => import('../sections/promotion/events/blockFAQ'), { ssr: false });
